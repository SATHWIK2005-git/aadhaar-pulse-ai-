...
# =========================
# OFFICIAL INDIA REGIONS (28 STATES + 8 UTs)
# =========================
OFFICIAL_REGIONS = {
...
# 🔥 CRITICAL FILTER (fixes 43-state issue & Odisha bug)
data = data[data["state"].isin(OFFICIAL_REGIONS)]
...
st.dataframe(
    district_view[
        ["district","rush_index","migration_score","digital_literacy_score",
         "fraud_category","fraud_risk_score","recommended_action"]
